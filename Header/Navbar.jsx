...
function Navbar() {
 const menuItems = [
  { name: "Medicines", icon: pillsIcon },
  { name: "Vitamins", icon: vitaminsIcon },
  { name: "Beauty", icon: skincareIcon },
  { name: "Hygiene", icon: washinghandsIcon },
  { name: "Lenses", icon: eyeIcon },
  { name: "Mother & Child", icon: babyboyIcon },
  { name: "Medical Products", icon: firstaidkidIcon },
  { name: "Pet Products", icon: dogIcon },
  { name: "Medical Equipment", icon: smartwatchIcon },
];
